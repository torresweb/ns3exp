...
#plot f(x) title 'valor teórico' with lines linestyle 1, "new_waiting.log" title 'valor medido' with lines linestyle 2
plot f(x) title 'valor teórico' with lines linestyle 1, "new2_waiting.log" title 'valor medido' with lines linestyle 2
